...
class SQLitePersonRepository(Repository):
    def __init__(self, db_path):
        ...
        self.person_operations = SQLite_person_operations
    ...
    def read_by_id(self, person_id: int) -> Person | None:
        ...
        return self.person_operations.select_person_by_id(self.db_path, person_id)
    ...
    def read_by_other_id(self, purchase_id: int) -> list[Person] | None:
        ...
        return self.person_operations.select_persons_by_purchase_id(self.db_path, purchase_id)


    def read_all(self) -> list[Person] | None:
            return self.person_operations.select_all_persons(self.db_path)
